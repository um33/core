...
from .const import (
    CONF_TIMEFRAME,
    DEFAULT_TIMEFRAME,
    ICON_MDI_COMPASS_OUTLINE,
    ICON_MDI_GAUGE,
    ICON_MDI_WEATHER_PARTLYCLOUDY,
    ICON_MDI_WEATHER_POURING,
    ICON_MDI_WEATHER_WINDY,
...
SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    ...
    SensorEntityDescription(
        ...
        native_unit_of_measurement=PERCENTAGE,
        icon=ICON_MDI_WEATHER_PARTLYCLOUDY,
    ),
    SensorEntityDescription(
        key="sunchance_2d",
